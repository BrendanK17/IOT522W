...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      ...
      } lg:relative lg:w-64 border-r flex flex-col h-screen`} // use flex-col and h-screen
    >
      {/* Main Menu */}
      <nav className="flex-1 overflow-auto px-3 py-4"> {/* flex-1 and overflow-auto to allow scrolling if content is large */}
        <div className="px-3">
      ...
      {/* Active Status - placed explicitly at bottom */}
